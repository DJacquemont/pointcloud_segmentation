...
data_file_path = os.path.join(path_to_output, 'processing_time.txt')

# Load the data from the text file
data = pd.read_csv(data_file_path, header=None, names=['Processing Time'])

# Plotting the boxplot
plt.figure(figsize=(8, 6))
plt.boxplot(data['Processing Time'])
